...
EXCLUDED_INDICES = ('.opendistro_security', '.aws_cold_catalog_1', '.opendistro-reports-instances', '.opendistro-reports-definitions')
...
def restore_snapshot(host: str, awsauth: AWS4Auth, repo_name: str, snapshot_name: str):
    ...
    indices = ['*'] + indices
    print(f'Indices to be restored: {indices}')
    ...
    # Open closed indices
    open_indices_by_names(host, awsauth, repo_name, index_names=closed_indices)
